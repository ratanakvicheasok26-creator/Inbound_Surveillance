...
from graph.compile import compile_to_config, pipeline_runtime_flags, validate_graph
...
class GraphCompileTests(unittest.TestCase):
    ...
    def test_sidecar_build_requires_graph_and_workplace_modules(self) -> None:
        ...
        for name in ("graph", "graph.compile", "workplaces", "workplaces.customer_visits"):
