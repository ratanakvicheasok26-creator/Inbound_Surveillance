...
export const NODE_CATALOG: Record<PipelineNodeKind, NodeCatalogEntry> = {
  ...
  anonymousReid: { kind: "anonymousReid", label: "Anonymous re-ID", group: "vision", summary: "Appearance match, no names" },
  ...
  customerVisits: { kind: "customerVisits", label: "Customer visits", group: "monitor", summary: "Day / week uniques" },
